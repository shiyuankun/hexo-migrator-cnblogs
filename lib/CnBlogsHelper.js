...
var getCategorysAndTags = function (post, html, callback) {
...
var helper = function () {
    return {
        getCategorysAndTags: getCategorysAndTags,
        getPageFileName: getPageFileName,
        translatePreToHexoCodeFormat: translatePreToHexoCodeFormat
    };
};
